...
<template>
  <form @submit.prevent="handleRegister" class="card-body">
    ...
    <div class="form-control">
      ...
      <label
        class="input input-bordered flex items-center gap-2 transition-all"
        :class="{
          'border-error !outline-error': !validateUsername && username,
        }"
      >
        <svg
          ...
          viewBox="0 0 16 16"
          fill="currentColor"
          :class="{ 'fill-error': !validateUsername && username }"
    ...
    <div class="form-control">
      ...
      <label
        ...
        class="input input-bordered flex items-center gap-2 transition-all"
        :class="{
          'border-error !outline-error': !validatePassword && password,
        }"
      >
        <svg
      ...
      <p
        ...
        "
      >
        Password has to include be at least 8 characters, special character and
        a number!
      </p>
      <label class="label">
      ...
      <label class="mt-2">
        ...
        <RouterLink to="/login" class="link link-hover text-accent"
          >Sign in!</RouterLink
        >
      </label>
    </div>
    ...
    <div class="form-control mt-6">
      ...
      >
        <Transition>
          <span
            v-if="loading"
            class="loading loading-spinner loading-sm opacity-50"
          ></span>
        </Transition>
